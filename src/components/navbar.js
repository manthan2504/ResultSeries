      ...
      <ul className="hidden md:flex items-center space-x-6 text-gray-700 font-medium">
        ...
        >
          ...
          {servicesOpen && (
            <div className="absolute left-0 top-full bg-white shadow-md rounded-md text-sm p-2 z-50">
              <Link
                to="/services/trade_&_investment_facilitators"
                className="block px-4 py-2 hover:bg-orange-600 hover:text-white"
              >
        ...
        >
          ...
          {connectOpen && (
            <div className="absolute left-0 top-full bg-white shadow-md rounded-md text-sm p-2 z-50">
              <Link
                to="/stay_connected/get_in_touch"
                className="block px-4 py-2 hover:bg-orange-600 hover:text-white"
              >
                GET IN TOUCH
              </Link>
              <hr className="my-2 border-t border-gray-300" />
              <Link
                to="/stay_connected/join_our_team"
                className="block px-4 py-2 hover:bg-orange-600 hover:text-white"
              >
                JOIN OUR TEAM
              </Link>
      ...
      {mobileOpen && (
        <div className="absolute top-[80px] left-0 w-full bg-white shadow-md z-50 md:hidden">
          <ul className="flex flex-col space-y-4 p-4 text-gray-700 font-medium">
            ...
            {/* Mobile Icons + ESTD */}
            <li className="flex flex-col items-center gap-1 text-sm text-gray-600 pt-4 border-t border-gray-300">
              <div className="flex gap-3">
                <a
                  href="mailto:example@email.com"
                  target="_blank"
